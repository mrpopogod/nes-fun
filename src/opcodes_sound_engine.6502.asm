...
NUM_SONGS = $08 ;if you add a new song, change this number.    
...
song_headers:
    ...
    .include "sound_opcodes.6502.asm"    ;our opcode subroutines, jump table and aliases
    ...
    .include "opcodes_song0.6502.asm"  ;holds the data for song 0 (header and data streams)
    .include "opcodes_song1.6502.asm"  ;holds the data for song 1
    .include "opcodes_song2.6502.asm"
    .include "opcodes_song3.6502.asm"
    .include "opcodes_song4.6502.asm"
    .include "opcodes_song5.6502.asm"
    .include "opcodes_song6.6502.asm"
    .include "opcodes_song7.6502.asm"