...
InitializeNametablesLoop:
  ...
  STA scroll
  INC columnNumber
  LDA columnNumber      ; repeat to fill out first nametable 
  CMP #$20
...
NMIHandler:
  ...
  INC scroll
  INC scroll
  INC scroll            ; tried out going up to a full tile every frame
                        ; works just fine since we still have the offscreen
                        ; section.  Going more than a tile a frame breaks down.
                        ; You get graphical glitches due to the math being off
