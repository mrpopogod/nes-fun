...
@opcode:                     ;else it's an opcode
    ...
    bne @silence            ;use a branch rather than a jmp to save a byte (but still 3 cycles)
@silence_tri:
...
NUM_SONGS = $05 ;if you add a new song, change this number.    
...
song_headers:
    ...
    .w song4_header  ;my poor attempt at a song
    
    .include "note_table.6502.asm" ;period lookup table for notes
    .include "headers_song0.6502.asm"  ;holds the data for song 0 (header and data streams)
    .include "headers_song1.6502.asm"  ;holds the data for song 1
    .include "headers_song2.6502.asm"
    .include "headers_song3.6502.asm"
    .include "headers_song4.6502.asm"