...
song_headers:
    ...
    .include "opcodes2_song0.6502.asm"  ;holds the data for song 0 (header and data streams)
    .include "opcodes2_song1.6502.asm"  ;holds the data for song 1
    .include "opcodes2_song2.6502.asm"
    .include "opcodes2_song3.6502.asm"
    .include "opcodes2_song4.6502.asm"
    .include "opcodes2_song5.6502.asm"
    .include "opcodes2_song6.6502.asm"
    .include "opcodes2_song7.6502.asm"
    .include "opcodes2_song8.6502.asm"